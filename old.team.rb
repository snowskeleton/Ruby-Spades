...
class Team
	...
	def self.list_score
		...
		@@list.first.score <= @@list.last.score - 100 ? @@list.first.set_blind_perm=(true) : @@list.first.set_blind_perm=(false)
		@@list.last.score <= @@list.first.score - 100 ? @@list.last.set_blind_perm=(true) : @@list.first.set_blind_perm=(false)
	end
